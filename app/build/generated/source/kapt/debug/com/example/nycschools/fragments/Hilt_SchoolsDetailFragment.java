 ...
 */
public abstract class Hilt_SchoolsDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SchoolsDetailFragment() {
    super();
  }

  Hilt_SchoolsDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SchoolsDetailFragment_GeneratedInjector) this.generatedComponent()).injectSchoolsDetailFragment(UnsafeCasts.<SchoolsDetailFragment>unsafeCast(this));
    }
  }
