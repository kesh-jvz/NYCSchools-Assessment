 ...
 */
public abstract class Hilt_SchoolsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SchoolsFragment() {
    super();
  }

  Hilt_SchoolsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SchoolsFragment_GeneratedInjector) this.generatedComponent()).injectSchoolsFragment(UnsafeCasts.<SchoolsFragment>unsafeCast(this));
    }
  }
